...
local image_name = "drone-git-signed-commit-check";

local github_repo_name = "drone-git-signed-commit-check";
local github_desc = "drone plugin for checking or verifying git signed commits in a repository";
local url = "https://rm.byterazor.de/projects/drone-git-signed-commit-check";

local REDMINE_PROJECT_ID="drone-git-signed-commit-check";
local REDMINE_URL="https://rm.byterazor.de";

local MAIN_REPO="Container/drone-git-signed-commit-check";
